...
**Action Points and Existing Games**<br>
...
**Metamagic/Metapsionic Feats** *Edited*<br>
You can spend 1 action point for each level the metamagic feat would normally increase the spell level by, and metapsionic feats require 1 action point per 2 power points spent when adding the effect of any one metamagic/metapsionic feat that you have to a spell/power you are casting. The spell/power is cast/manifested at its normal level (without any level adjustment because of the feat) and takes no extra time to cast. IE: Maximize Spell and Maximize Power would require 3 action points. Heighten Spell only requires 1 action point.
