...
Across the sphere, each great tribe maintains its own spelljamming fleet—skybound banners of their strength, adorned in crests of fanged beasts, sacred hides, and metalworked prows shaped like roaring spirits. These warships are crafted for duels in the void, swift raids across wildspace, or ceremonial escort during celestial rites. Their forms and functions vary wildly—some are living vessels grown from sungrove bark, others are ironclad leviathans chiseled from fallen meteors. Though rivalries often flare between clans, tales still echo of the age when all the fleets flew as one. Known as the Pride Fleet, this legendary armada rose in a forgotten age to face a dire threat: an incursion of ancient humans from another sphere, who came with chains and fire, seeking to enslave the beastfolk and bend their strength to imperial will. United in defiance, the tribes became a storm, and the sky burned with the glory of their resistance. The humans were cast out, their ships broken and scattered across the stars. Since that age, no such unity has returned, but the memory of the Pride Fleet endures in song, in story, and in the silent challenge of every rising war-banner.

At the center of the sphere burns Solarianus, a golden presence that lights the void between stars. Yet it is no true sun. Solarianus is a wound in the heavens, a radiant breach into the Positive Energy Plane. The light it casts bears no warmth, nor does it burn—but it pulses with life. This brilliance feeds no crops, but it quickens the soul and stirs the strength in all living things. From its unseen depths flows the power that sustains the Bellatoris Sphere, an energy that shapes the beasts, the lands, and the very air with raw, enduring vitality.
...
- Sphere Type: Star-Based
- Primary Body: Solarianus (Positive Energy Manifest Zone)
...
- Thassari
    ...
    - Type: Terrestrial
    - Shape: Spherical
    - Other Notes: Thassari is a world of vertical verdancy—great stone pillars covered in blooming terraces, cliffside forests, and high-altitude wetlands that shimmer with bioluminescent flora. Life grows wherever it can cling. Gliders, winged beasts, and climbing predators dominate the skies between plateaus. Waterfalls pour from root-choked heights, and rare plants used in vision-quests grow only on sun-drenched ledges. The tribes here are reclusive, graceful, and fiercely territorial.
...
- Caerakos
    ...
    - Type: Terrestrial
    - Shape: Spherical
    - Other Notes: Caerakos is a high plain world of sparse grasslands, scattered thorn-forests, and flower-specked riverbeds. Verdant only during certain celestial alignments, it blooms violently after storms, then dries into sweeping ranges of brittle foliage and hardy brush. Clans here ride in great herds, following the lifebloom migrations. Trees are few, but every one is named and protected. Storms are considered divine heralds, and lightning scars are read like scripture.
