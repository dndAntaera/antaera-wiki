...
!!! tip "This is a starter scaffold"
    Replace the placeholder text on these pages with your own material. The
    structure below is a suggestion, not a constraint — add, rename, or delete
    sections freely in `mkdocs.yml`.

## Sections

<div class="grid cards" markdown>

-   :material-map: **[World](world/index.md)**
